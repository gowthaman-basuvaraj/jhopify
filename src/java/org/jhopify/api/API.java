...
public class API {
	...
	public static final String SHOPIFY_API_COLLECT_URI_PREFIX = SHOPIFY_API_URI_PREFIX + "collects";
	public static final String SHOPIFY_API_OBJECT_LIST_LIMIT_PARAMETER_NAME = "limit";
